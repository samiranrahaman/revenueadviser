										...
										<div class="row " ng-repeat="prodctitem in setupproducts " style="border: 1px solid #ecf0f5;padding: 11px 5px 17px 20px;background: #d1d7de;">
											  <div class="col-sm-2">{{prodctitem.report_name}}</div>
											   <div class="col-sm-3">{{prodctitem.setup_date}}</div>
												 ...
												 <div class="col-sm-4">
												 <a ng-if="prodctitem.total_price!=0" class="btn btn-info" style="padding: 0px 15px 5px 9px;" href="<?php echo base_url();?>index.php/reports/viewreport/{{prodctitem.id}}">View</a>
												 <a ng-if="prodctitem.total_price==0" class="btn btn-info" style="padding: 0px 15px 5px 9px;" href="javasceipr:void(0);">View</a>
												 |
												 <button class="btn-danger" ng-click="delete(prodctitem.id)">Delete</button>|
												  <a class="btn btn-info" style="padding: 0px 15px 5px 9px;" href="<?php echo base_url();?>index.php/newproductadd/othercostedit/{{prodctitem.id}}">Edit</a></div>
