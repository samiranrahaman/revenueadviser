		...
		<!-- Chalanges cost start-->
			...
			<tbody>
			  ...
			  <tr ng-repeat="data_ch2 in costlist2 ">
				...
				<td>
				<!--<input ng-keyup="change($event, data_ch2.order)" ng-model="data_ch2.order">-->
				<input ng-keyup="change($event,grossprofit2 =data_ch2.unit_price * data_ch2.order)" ng-init="grossprofit2=grossprofit2" ng-model="data_ch2.order">
				{{grossprofit2}}
		...
		<!-- chalanges revenue end-->
		 ...
		 <div class="row" >
			...
			<tbody>
			  ...
			  <tr style="background-color: bisque;">
				<td>Net Profit</td> 
				<td>{{grossprofit2 - (expenses2 + mislan2) | currency}}</td> 
			  </tr>
			</tbody>
		  </table>
