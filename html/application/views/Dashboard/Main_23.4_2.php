        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
					  ...
					  <small ng-if="total_cog2==' '"  class="labela label-danger">{{((total_cog-total_cog2)/total_cog2)*100 | number:0}}%</small></h5>
                      <span>COGS</span>
                    </div>
                </div>
        	</div>
					       ...
					       url : '<?php echo base_url();?>index.php/reports/get_analysis_graph_data',
							...
							data :JSON.stringify({datevalue1:datevalue1, datevalue2:datevalue2,report_id:report_id})
							  ...
							  console.log(data);
							   ...
							   $scope.series = ['Gross Profit', 'Revenue','Ad Spend','Net Profit','Net Margin'];
			    ...
			    //alert(report_id);
					...
					url : '<?php echo base_url();?>index.php/reports/get_prev_analysis_data',
							...
							/* 
							 ...
							 $scope.total_cog2=Math.round(data[2].suppliertotal_cost)+Math.round(data[3].fulfillment)+Math.round(data[4].stripeorder)+Math.round(data[5].mislan );
