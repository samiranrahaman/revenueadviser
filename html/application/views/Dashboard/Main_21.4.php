								...
								<table class="table table-striped">
									...
									<tbody>
										...
										<tr>
											...
											<td>
											<a data-toggle="collapse" data-target="#demo">  <i class=" fa fa-plus-square-o" ></i>  1010 </a>
											</td>
											
													<div id="demo" class="collapse marg">
													<ul>
													<li class="tblbdr">
														<span class="dtr-title">Shipping Method</span> 
														<span class="dtr-data">Other</span>
													</li>
													<li class="tblbdr">
														<span class="dtr-title">Tracking Number</span> 
														<span class="dtr-data">LW018619678CN</span>
													</li>
													<li class="tblbdr">
														<span class="dtr-title">Product(s)</span>
														<span class="dtr-data">Ladies Clutch Puppy Wallet - blue</span></li>
													<li class="tblbdr">
														<span class="dtr-title">Refund</span> 
														<span class="dtr-data">$0.00</span>
													</li>
													<li class="tblbdr">
														<span class="dtr-title">Handling Fee</span> 
														<span class="dtr-data">$0.00</span>
													</li>
													<li class="tblbdr">
														<span class="dtr-title">Tax</span>
														<span class="dtr-data">$0.00</span>
													</li>
													<li class="tblbdr">
														<span class="dtr-title">Transaction Fee</span> 
														<span class="dtr-data">$0.77</span>
													</li>
												</ul>
													</div> 
