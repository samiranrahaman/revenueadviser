...
<!--http://jtblin.github.io/angular-chart.js/-->
  ...
  <input type="text"  style="display:block" class="form-control"   name="stardate1" id="stardate1" ng-model="stardate1" required> 
  <input type="text"  style="display:block" class="form-control"   name="enddate1" id="enddate1" ng-model="enddate1" required> 
  
  
  <input type="text"  style="display:block" class="form-control"   name="report_id" id="report_id" ng-model="report_id" required> 
  <input type="text"  style="display:block" class="form-control"   name="report_name" id="report_name" ng-model="report_name" required> 
		...
		chart-dataset-override="datasetOverride" chart-click="onClick">
          ...
          <script>
			 ...
			 angular.module("myApp", ["chart.js","ui.bootstrap.modal"]).controller("reports", function ($scope,$http,$timeout,$window) {
				 ...
				 $scope.init=function()
				  {
					   ...
					   $scope.analysis($scope.stardate1,$scope.enddate1);
										 ...
										 $('input[name="daterange"]').daterangepicker(
											...
											function(start, end, label) {
												...
												// $scope.stardate1=start.format('YYYY-MM-DD');
												 $scope.analysis(start.format('YYYY-MM-DD'),end.format('YYYY-MM-DD'));
			  ...
			  $scope.analysis = function (datevalue1,datevalue2)
			  {
