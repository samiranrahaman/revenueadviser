	...
	//exit;
				 	...
				 	try {
						   ...
						   //done
							...
							$customer -> description = "Plan Upgrade";
					...
					if ($result->num_rows > 0) 
					{
					 ...
					 $to = "samiran1109@gmail.com,".$email;
						$subject = "Inubaan Software Product - Subscription Upgradation Mail ";
		   $message ='<table width="480" cellspacing="0" cellpadding="0" border="0">
							...
							<p>Your Subscription Plan Upgraded successfully.Your account is Now Active.</p>
							<p><a href="http://profitandloss.io/login">Please click to Login.</a></p>
							<br>
                ...
                //$sql1="update `rev_user` set user_status=0 where `user_interanal_id`='$user_id'";
				 $sql1="update `rev_user` set subscription='$plan_id' where `user_interanal_id`='$user_id'"; 
		         $conn->query($sql1);
				 
				// $sql1="update `rev_stripe_payment_history` set subscription='$plan_id' where `user_interanal_id`='$user_id'"; 
				  ...
				  $sql2 = "update rev_stripe_payment_history set str_id='$str_id',
							 ...
							 reg_discount=0
							 where id=".$stripe_payment_history_id;
				 
		         $conn->query($sql2);
				 
				 
				header('Location: http://profitandloss.io/profile?status=1');
				 //echo  1;
				...
				$error = $e->getMessage();
					//$result = "declined";
					//echo  0;
					header('Location: http://profitandloss.io/profile?status=0');
